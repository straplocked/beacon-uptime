...
| 6 — Differentiator #2 | ✅ Shipped (PR #5) | Auto-branded status pages: favicon → palette → theme, applied to the public page; extract_status_page_palette MCP tool; SSRF-guarded fetch |
